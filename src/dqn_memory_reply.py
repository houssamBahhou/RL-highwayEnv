...
# Here we define our transition (state, action, next_state, reward)
...
# This class define our replay memory.
# It stores the transitions that the agent observes, 
# allowing us to reuse this data later.
# By sampling from it randomly
# We use this technique to compute loss on batches with no correlated states
...
modele()
torch.save(policy_net.state_dict(), "../models/model_400")
...
policy_net.load_state_dict(torch.load("../models/model_400"))
